...
for president in presidents:
    ...
    speeches += extract_column_from_excel_files(f'C:/Users/OSP/Desktop/미니프로젝트/대통령 연설문 분석/데이터 전처리/{president}','연설문')
